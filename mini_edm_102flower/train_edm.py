...
if __name__ == "__main__":
    ...
    channels = {'mnist': 1, 'cifar10': 3, 'Oxford_flower': 3, 'Scene': 3}
    config.channels = channels[config.dataset]
    image_size = {'mnist': 32, 'cifar10': 32, 'Oxford_flower': 128,"Scene": 128}
    ...
    if config.dataset == 'mnist':
        ...
        img_dataset = torchvision.datasets.ImageFolder(root="/home/jingyang/work/dataset/Scene/", transform=transform)
